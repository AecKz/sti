...
<script src="js/controladores/incidencias.js"></script>
				...
				<div class="left_col scroll-view">
					...
					<div id="sidebar-menu"
						...
						<div class="menu_section">
							<h3 id="tituloLateral">Incidencias</h3>
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">
							...
							<div class="row x_title">
								<div>
									<h3 id="lblTitulo">Incidencias</h3>
								</div>
							</div>
							<div class="col-md-12 col-sm-12 col-xs-12">
								...
								<div class="panel panel-default">
									...
									<ul class="list-group" id="listaResueltas">
									</ul>
								</div>
								<div class="panel panel-default">
									<div class="panel-heading">
										<h3 class="panel-title">Incidencias Cerradas</h3>
									</div>
									<ul class="list-group" id="listaCerradas">
									</ul>
								</div>
